...
export function CardCar(props: CardCarProps) {
    ...
    return (
        <div className='relative p-1 bg-white rounded-lg shadow-md hover:shadow-lg'>
            <Image src={car.photo} alt={car.name} width={600} height={600} className='rounded-lg' />
            {car.isPublish ? (
            ...
            <div className='relative p-3'>
                ...
                {car.isPublish ? (<Button className='w-full mt-3' variant='outline' onClick={() => handlerPublishCar(false)}>
                    Unpublish
